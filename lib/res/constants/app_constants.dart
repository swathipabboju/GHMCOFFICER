...
import 'package:ghmcofficerslogin/model/concessioner/c_incharge_ticketlist_res.dart' as cinchargetickelist;
import 'package:ghmcofficerslogin/model/concessioner/concessionaire_incharge_manual_closing_tickets_res.dart' as manualticketlist;
import 'package:ghmcofficerslogin/model/plant_operator/get_plant_operator_response.dart';
import 'package:ghmcofficerslogin/model/get_vehicles_reponse.dart' as requestestimationvehiclestypelist;
import 'package:ghmcofficerslogin/model/amount_paid_response.dart' as amohamountpaid;
import 'package:ghmcofficerslogin/model/request_estimation_response.dart' as requestestimationvehiclelist;
import '../../model/c_closed_tickets_response.dart' as concessionerclosedticketslist;
import 'package:ghmcofficerslogin/model/amoh_closed_ticket_list_response.dart' as amohcloseticketdetails;

import '../../model/concessioner/concessionaire_pickup_capturelist_res.dart' as pickupcapturelist;
...
//static List<Comments>? concessionaireInchargeManualClosingTicketlist = null;
 ...
 static cinchargetickelist.ChargeTicketList? c_incharge_ticket_list = null;
  static cinchargetickelist.CInchargeVehicleList? c_incharge_ticket_list_vehicle_list =
      null;
...
//request estimation
 static requestestimationvehiclelist.VehicleList? request_estimation_vehiclelist = null;
