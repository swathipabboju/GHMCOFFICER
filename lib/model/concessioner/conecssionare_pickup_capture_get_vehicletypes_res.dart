class ConcessionairePickupCaptureGetVehicleTypesRes {
  String? sTATUSCODE;
  String? sTATUSMESSAGE;
  List<VEHICLELIST>? vEHICLELIST;

  ConcessionairePickupCaptureGetVehicleTypesRes(
      {this.sTATUSCODE, this.sTATUSMESSAGE, this.vEHICLELIST});

  ConcessionairePickupCaptureGetVehicleTypesRes.fromJson(
