class ClosedTicketsListResponse {
  String? sTATUSCODE;
  String? sTATUSMESSAGE;
  List<AmohConclosedTicketList>? ticketList;

  ClosedTicketsListResponse(
      {this.sTATUSCODE, this.sTATUSMESSAGE, this.ticketList});

  ClosedTicketsListResponse.fromJson(Map<String, dynamic> json) {
    sTATUSCODE = json['STATUS_CODE'];
    sTATUSMESSAGE = json['STATUS_MESSAGE'];
    if (json['TicketList'] != null) {
      ticketList = <AmohConclosedTicketList>[];
      json['TicketList'].forEach((v) {
        ticketList!.add(new AmohConclosedTicketList.fromJson(v));
      });
    }
  }
...
class AmohConclosedTicketList {
  ...
  AmohConclosedTicketList.fromJson(Map<String, dynamic> json) {
